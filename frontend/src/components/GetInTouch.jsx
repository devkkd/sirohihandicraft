        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col pt-4">
            ...
            <div className="flex flex-col gap-6 text-sm md:text-[15px] text-gray-800">
              ...
              <p><span className="font-extrabold text-[#2d2926]">Certifications:</span> Sedex Smeta · FSC Certified</p>
            </div>
          </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col">
                  ...
                  <div className="mt-14">
                    ...
                    <button type="submit" disabled={submitting}
                      ...
                      {submitting ? <div className="w-4 h-4 bg-[#645643] hover:bg-[#4d4233] border-2  border-white border-t-transparent rounded-full animate-spin" /> : <>REQUEST A QUOTE <FiArrowRight size={16} strokeWidth={2.5} /></>}
                    </button>
                  </div>
                </form>
              </>
