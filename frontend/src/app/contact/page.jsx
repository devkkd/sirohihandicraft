      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 mb-20 lg:mb-28">
                ...
                <>
                  ...
                  <div className="mt-14">
                    ...
                    <button type="submit" disabled={submitting}
                      className="bg-[#4a4238] hover:bg-[#3f3931] text-white px-8 py-3.5 rounded-full text-xs font-bold tracking-widest flex items-center justify-center gap-2 transition-colors w-max disabled:opacity-60">
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            <div className="bg-[#FBF3E6] rounded-3xl flex flex-col shadow-sm">
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="w-full h-[400px] md:h-[500px] rounded-3xl overflow-hidden bg-gray-200 border border-[#e0dacd] shadow-sm">
            <iframe
              width="100%"
              height="100%"
              style={{ border: 0 }}
